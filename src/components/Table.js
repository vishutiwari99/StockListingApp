            ...
            <div className="">
                <div className="w-full lg:w-5/6">
                    <div className="bg-white shadow-md rounded my-6">
                        <div className="bg-gray-50 w-max m-2 flex  items-center justify-start px-12">
                            <h1>Stock Details Table</h1>
                            <input className="bg-gray-200 mx-32 p-1" type="text" placeholder="Search by company Name" />
                        </div>
